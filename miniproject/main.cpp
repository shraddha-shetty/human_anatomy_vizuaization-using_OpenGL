...
void frontscreen(void)
{
    ...
    drawstring(-28,50,0.0,"AJ INSTITUTE OF ENGINEERING AND TECHNOLOGY");
    glColor3f(1,0,0);
    ...
    glColor3f(0.5,0,0.5);
    drawstring(-35,-10,0.0,"SHRADDHA (4JK18CS057)");
    strflag=0;
    drawstring(-35,-14,0.0,"SANJANA SHETTY (4JK18CS053)");
    glColor3f(1,0,0);
    drawstring(15,0,0.0,"GUIDE:");
    glColor3f(0.5,0,0.5);
    drawstring(15,-10,0.0,"MRS.SHARANYA");
    strflag=0;
...
drawstring1(-23,22.5,0.0,"into little pieces that are easier to digest and swallow.Also, the saliva is more than just water.");
drawstring1(-23,20,0.0,"It has special enzymes in it that start to breakdown starchy food while chewing.");
strflag=2;
glColor3ub(0, 207, 119);
drawstring1(-35,16,0.0,"2. Swallowing");
strflag=0;
glColor3f(0,0,0);
drawstring1(-20,16,0.0,"may seem like a simple process to us. But food doesn't just fall down our throats ");
drawstring1(-20,13.5,0.0,"into the stomach.");
strflag=2;
glColor3ub(0, 207, 119);
drawstring1(-35,9,0.0,"3. Stomach");
strflag=0;
glColor3f(0,0,0);
drawstring1(-23,9,0.0,"The next stage is the stomach. Food hangs out in the stomach for around four hours. ");
drawstring1(-23,6.5,0.0,"While the food sits there, more enzymes go to work on it, breaking down things like proteins ");
drawstring1(-23,4,0.0,"that our bodies can use. The stomach kills a lot of bad bacteria as well, so we don't get sick.");
strflag=2;
glColor3ub(0, 207, 119);
...
drawstring1(-21,-26.5,0.0,"Both work with the small intestine. The liver provides bile that helps break up fat into");
drawstring1(-21,-29,0.0,"smaller bits. The pancreas provides additional enzymes to help digest all sorts of food. ");
...
drawstring1(13,14.2,0,"Rings of Cartilage");
drawline(-1,5,10,5);
...
drawstring1(-24,22.5,0.0," expand and fill with air. When we breathe in, air gets a forced through our nose or mouth,");
drawstring1(-24,20,0.0," down our windpipe, and into bronchi tubes in our lungs.These bronchi tubes branch out and ");
drawstring1(-24,17.5,0.0," get smaller and smaller,like the roots or branches of tree.");
strflag=2;
glColor3ub(0, 207, 119);
...
drawstring1(-24,9.5,0.0,"These air sacs have a very thin,one cell thick wall that allows oxygen to be passed to ");
drawstring1(-24,7,0.0,"red blood cells as they are passing.There are hundreds of millions of alveoli.");
strflag=2;
glColor3ub(0, 207, 119);
...
glColor3f(0,0,0);
strflag=0;
drawstring1(-23,25,0.0,"Kidneys are blood filters,they are responsible for removing waste from our blood and extra");
drawstring1(-23,22.5,0.0,"water that our body doesn't need. We have two kidneys. They're shaped like large beans");
drawstring1(-23,20,0.0,"and sit toward our back, near the bottom of body travels through the kidneys to get cleaned.");
strflag=2;
glColor3ub(0, 207, 119);
drawstring1(-35,12,0.0,"2. Ureters and Bladder");
strflag=0;
glColor3f(0,0,0);
drawstring1(-10,12,0.0,"the waste water filtered by our kidneys becomes urine. Urine leaves the kidneys ");
drawstring1(-23,9.5,0.0,"through two tubes called ureters. The ureters job is to transport urine from kidneys to the bladder,");
drawstring1(-23,7,0.0,"which is the temporary storage organfor urine.");
}

void circulatoryDesc()
{
glColor3ub(253, 123, 119);//border
glBegin(GL_LINE_LOOP);
glVertex3f(47,50,0);
...
glColor3f(0.7,0,1);
strflag=1;
drawstring1(-20,45,0.0,"Human Circulatory System");
drawstring(-35,30,0.0,"Here are the major parts of the Circulatory system:");
strflag=2;
glColor3ub(0, 207, 119);
drawstring1(-35,25,0.0,"1. Heart:");
glColor3f(0,0,0);
strflag=0;
drawstring1(-24,25,0.0,"About the size of two adult hands held together, the heart rests near the center of the chest.");
drawstring1(-24,22.5,0.0,"Thanks to consistent pumping, the heart keeps the circulatory system working at all times.");
strflag=2;
glColor3ub(0, 207, 119);
drawstring1(-35,17,0.0,"2. Arteries:");
strflag=0;
glColor3f(0,0,0);
drawstring1(-21,17,0.0,"Arteries carry oxygen-rich blood away from the heart to where it needs to go.");
strflag=2;
glColor3ub(0, 207, 119);
drawstring1(-35,10,0.0,"3. Veins:");
strflag=0;
glColor3f(0,0,0);
drawstring1(-24,10,0.0,"Veins carry deoxygenated blood to the heart where it is directed to the lungs to receive oxygen.");
strflag=2;
glColor3ub(0, 207, 119);
drawstring1(-35,3,0.0,"4. Blood:");
strflag=0;
glColor3f(0,0,0);
drawstring1(-24,3,0.0,"Blood is the transport media of nearly everything within the body.It transports hormones, nutrients,");
drawstring1(-24,1,0.0,"oxygen, antibodies and other important things to keep the body healthy.");
}
